...
if (process.platform === 'win32') {
	if (!hasSupportedVisualStudioVersion()) {
		console.warn('\x1b[1;33m*** Invalid C/C++ Compiler Toolchain. Please check https://github.com/microsoft/vscode/wiki/How-to-Contribute#prerequisites.\x1b[0;0m');
		console.warn('\x1b[1;33m*** Skipping header installation for now.\x1b[0;0m');
		// throw new Error();
	} else {
		try {
	installHeaders();
		} catch (e) {
			console.warn('\x1b[1;33m*** Failed to install headers, continuing anyway...\x1b[0;0m');
		}
	}
}
