...
export const subTextMdOfProviderName = (providerName: ProviderName): string => {
	...
	if (providerName === 'pollinations') return 'Get your [API Key here](https://enter.pollinations.ai). Supports both public (pk_...) and private (sk_...) keys. Read about [rate limits here](https://enter.pollinations.ai/api/docs).'
									...
									providerName === 'openAICompatible' ? 'sk-key...' :
										providerName === 'xAI' ? 'xai-key...' :
											providerName === 'mistral' ? 'api-key...' :
												providerName === 'pollinations' ? 'pk_... ou sk_...' :
...
export const defaultSettingsOfProvider: SettingsOfProvider = {
	...
	pollinations: { // aggregator (serves models from multiple providers)
		...defaultCustomSettings,
...
export type GlobalSettings = {
	...
	multiAgentSettings: import('./multiAgentTypes.js').MultiAgentSettings;
	ragSettings: import('./ragTypes.js').RAGSettings;
	agentSuperpowerMode: AgentSuperpowerMode | null;
