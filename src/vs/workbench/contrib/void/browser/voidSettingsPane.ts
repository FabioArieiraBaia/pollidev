...
class VoidSettingsInput extends EditorInput {
	...
	override getName(): string {
		return nls.localize('voidSettingsInputsName', 'PolliDev\'s Settings');
	}
...
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(
	EditorPaneDescriptor.create(VoidSettingsPane, VoidSettingsPane.ID, nls.localize('VoidSettingsPane', "PolliDev\'s Settings Pane")),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('voidSettings', "PolliDev: Alternar Configurações"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('voidSettingsAction2', "PolliDev: Abrir Configurações"),
			f1: true,
			icon: Codicon.settingsGear,
		});
	}
...
MenuRegistry.appendMenuItem(MenuId.GlobalActivity, {
	...
	command: {
		id: VOID_TOGGLE_SETTINGS_ACTION_ID,
		title: nls.localize('voidSettingsActionGear', "Configurações PolliDev")
	},
	order: 1
});
