...
// Register PolliDev icon - using symbolObject icon as it's similar to the logo concept
// Note: For a true custom icon, create an SVG version of the logo and use URI.file()
const voidViewIcon = registerIcon('pollidev-view-icon', Codicon.symbolObject, nls.localize('pollidevViewIcon', 'PolliDev chat view icon.'));
...
const container = viewContainerRegistry.registerViewContainer({
	...
	title: nls.localize2('voidContainer', 'PolliDev Chat'), // this is used to say "Void" (Ctrl + L)
