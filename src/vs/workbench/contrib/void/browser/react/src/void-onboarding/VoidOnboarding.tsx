...
const VoidIcon = () => {
	...
	// Usar classe void-pollidev-logo ao invés de void-void-icon
	return <div ref={divRef} className='@@void-scope void-pollidev-logo' />
}
				...
				<div key={providerName} className="w-full max-w-xl mb-10">
					<div className="text-xl mb-2">
						...
						{providerName === 'pollinations' && (
							<span
								data-tooltip-id="void-tooltip-provider-info"
								data-tooltip-content="Pollinations.ai offers free and paid tiers. Public keys (pk_...) have rate limits, private keys (sk_...) provide better limits and can spend Pollen."
								data-tooltip-place="right"
								className="ml-1 text-xs align-top text-blue-400"
							>*</span>
						)}
...
const VoidOnboardingContent = () => {
	...
	const lastPagePrevAndNextButtons = <div className="max-w-[600px] w-full mx-auto flex flex-col items-end">
		<div className="flex items-center gap-2">
			...
			>Enter PolliDev</PrimaryActionButton>
		</div>
	</div>
			...
			content={
				<div className='flex flex-col items-center gap-8'>
					...
					<div className='max-w-md w-full h-[30vh] mx-auto flex items-center justify-center'>
						<div 
							className="h-[30vh] w-[30vh] void-pollidev-logo void-logo-glow"
							style={{ 
								filter: 'drop-shadow(0 0 20px rgba(0, 127, 212, 0.6))'
							}}
