...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		ISharedBrowserService: accessor.get(ISharedBrowserService),
		IRAGIndexingService: accessor.get(IRAGIndexingService),
		IRAGVectorService: accessor.get(IRAGVectorService),
