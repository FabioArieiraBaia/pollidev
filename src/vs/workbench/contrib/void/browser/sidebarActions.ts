...
registerAction2(class extends Action2 {
	constructor() {
		super({ id: VOID_OPEN_SIDEBAR_ACTION_ID, title: localize2('voidOpenSidebar', 'PolliDev: Abrir Chat'), f1: true });
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('voidCmdL', 'PolliDev: Adicionar Seleção ao Chat'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: `Configurações da PolliDev`,
