...
import { SharedBrowserChannel } from '../../workbench/contrib/void/electron-main/sharedBrowserChannel.js';
import { ISharedBrowserMainService, SharedBrowserMainService } from '../../workbench/contrib/void/electron-main/sharedBrowserMainService.js';
/**
...
export class CodeApplication extends Disposable {
	...
	private async initServices(machineId: string, sqmId: string, devDeviceId: string, sharedProcessReady: Promise<MessagePortClient>): Promise<IInstantiationService> {
		...
		// Void added this - Shared Browser
		services.set(ISharedBrowserMainService, new SyncDescriptor(SharedBrowserMainService));
	...
	private initChannels(accessor: ServicesAccessor, mainProcessElectronServer: ElectronIPCServer, sharedProcessClient: Promise<MessagePortClient>): void {
		...
		// Void added this - Shared Browser
		const sharedBrowserMainService = accessor.get(ISharedBrowserMainService);
		const sharedBrowserChannel = new SharedBrowserChannel(sharedBrowserMainService);
		mainProcessElectronServer.registerChannel('void-channel-sharedBrowser', sharedBrowserChannel);
